...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    public TelaPrincipal() {
        ...
        bancoClientes = new BancoClientes(clientes);
        ...
        try {
            clientes = bancoClientes.pegaArquivo();
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(botaoLimpaEstoque, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(botaoLimpaLixeira, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE))
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(registraVenda, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {descontoPorcentagemTxt, descontoReaisTxt});
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(cpfCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 402, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(jLabel15)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cpfCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(46, 46, 46)
        ...
        jButton4.setText("Recuperar Lixeira");
        ...
        jTabbedPane1.addTab("Clientes", jInternalFrame4);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        for (int i = 0; i < (clientes.listaClientes().size()); i++) {
            if (nome.equals(clientes.getCliente(i).getNome())) {
                JOptionPane.showMessageDialog(null, "Cliente já cadastrado em sistema.");
                j = 1;
                break;
            }
        }
        if (j == 0) {
            if (nome.equals("")) {
                JOptionPane.showMessageDialog(null, "Insira um nome para o cliente.");
            } else {
                cliente = new Cliente(nome, cpf, clientes.listaClientes().size() + 1);
                clientes.adicionaCliente(cliente);
                Object[] row = {clientes.getCliente(clientes.listaClientes().size() - 1).getId(), nome, cpf};
    ...
    public void imprimeTabelaClientes(Clientes clientes, JTable tabela) {
        DefaultTableModel model = (DefaultTableModel) tabela.getModel();
        int i = clientes.listaClientes().size();
        int j = 0;
        while (j <= i - 1) {
    ...
    private void atualizaJsonClientes(Clientes clientes) {
        BancoClientes bancoClientes = new BancoClientes(clientes);
        try {
            bancoClientes.escreveArquivo();
        } catch (IOException ex) {
            ex.printStackTrace();
        }
    }
